...
export function LegalPage({
  ...
  return (
    <main className="min-h-screen bg-[#F7F8FA] px-5 py-12 text-[#1F2937] sm:py-20">
      <article className="mx-auto max-w-3xl rounded-[2rem] bg-white p-7 shadow-[0_24px_70px_rgba(0,0,64,.09)] ring-1 ring-black/5 sm:p-12">
        <Link
          href="/"
          className="text-sm font-bold text-[#4133BA] hover:text-[#000040]"
        >
          ← Return to website
        </Link>
        <p className="mt-10 text-xs font-bold uppercase tracking-[0.2em] text-[#4133BA]">
          {siteConfig.agent.name} · {siteConfig.agent.agency}
        </p>
        <h1 className="mt-3 font-heading text-4xl font-bold text-[#000040] sm:text-5xl">
          {title}
        </h1>
        ...
        <p className="mt-12 border-t border-black/10 pt-7 text-sm leading-6 text-[#5B6574]">
          ...
          <a
            className="font-bold text-[#000040]"
