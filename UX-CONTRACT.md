...
- Long-form package/promotions, project information and amenities preserve the owner's line breaks and remain optional. The public detail page does not render a separate generic overview/about card.
- For-sale detail pages include separate Mortgage Calculator and DSR Calculator views selected by two persistent buttons and prefilled from the listing price. Switching views preserves every entered value. Visitors can change property price, down payment percentage, annual interest rate and tenure up to 35 years in the mortgage view, then enter monthly income, statutory deductions and existing commitments in the DSR view. The mortgage formula drives the new-property instalment shown in the DSR calculation; net income, total commitments, DSR and disposable income update locally without a reload. Detailed financial inputs are not persisted or included in WhatsApp summaries. Results are illustrative only and never represent lender approval. Rental listings do not show this purchase-financing tool.
