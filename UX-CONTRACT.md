...
- For-sale detail pages include one combined Home Loan & DSR Calculator prefilled from the listing price. Visitors can change property price, down payment percentage, annual interest rate and tenure up to 35 years, then enter monthly income, statutory deductions and existing commitments. The existing mortgage formula drives the new-property instalment; net income, total commitments, DSR and disposable income update locally without a reload. Detailed financial inputs are not persisted or included in WhatsApp summaries. Results are illustrative only and never represent lender approval. Rental listings do not show this purchase-financing tool.
