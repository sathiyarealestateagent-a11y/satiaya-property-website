    ...
    <main className="overflow-hidden bg-background text-foreground">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-black/5 bg-white">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
          ...
          >
            <span className="grid size-11 place-items-center rounded-2xl bg-primary font-heading text-sm font-bold tracking-wide text-primary-foreground shadow-[0_8px_20px_rgba(0,0,64,.16)] transition-transform group-hover:-rotate-3">
      ...
      >
        <div className="absolute inset-0 overflow-hidden bg-[#000040]">
          <Image
          ...
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,64,.94)_0%,rgba(0,0,64,.79)_43%,rgba(65,51,186,.22)_73%,rgba(0,0,64,.18)_100%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_72%_35%,transparent_0%,rgba(0,0,64,.08)_42%,rgba(0,0,64,.54)_100%)]" />
          <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-[#000040]/80 to-transparent" />
        </div>
        ...
        <div className="relative mx-auto flex min-h-[700px] max-w-7xl items-center px-5 pb-44 pt-16 sm:px-8 lg:px-10 lg:pb-36">
          <div className="relative max-w-[50rem] text-white">
            <div className="mb-8 inline-flex items-center gap-3 text-xs font-bold uppercase tracking-[0.19em] text-white/85">
              <span className="grid size-8 place-items-center rounded-full border border-[#70D7FF]/55 bg-[#00B1FC]/12 backdrop-blur-md">
                <Sparkles className="size-3.5 text-[#70D7FF]" />
              </span>
              {siteConfig.hero.eyebrow}
              <span className="h-px w-10 bg-[#70D7FF]/70" />
            </div>
            ...
            <div className="mt-8 flex max-w-2xl items-stretch gap-4 sm:gap-5">
              <span className="w-px shrink-0 bg-gradient-to-b from-[#70D7FF] to-[#70D7FF]/20" />
            ...
            <div className="mt-10 flex w-fit flex-wrap items-center gap-x-3 gap-y-2 border-t border-white/18 pt-5 text-[13px] font-semibold text-white/72">
              <span className="grid size-8 place-items-center rounded-full bg-white/[.09] ring-1 ring-white/15 backdrop-blur-sm">
                <ShieldCheck className="size-4 text-[#70D7FF]" />
              </span>
              <span>
                {siteConfig.agent.registrationNumber || 'Registered negotiator'}
              </span>
              <span className="size-1 rounded-full bg-[#70D7FF]/75" />
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 translate-y-[42%] px-5 sm:px-8">
          <div className="mx-auto max-w-6xl rounded-[28px] border border-white/70 bg-white p-4 shadow-[0_24px_80px_rgba(0,0,64,.20)] sm:p-6">
            <div className="mb-4 flex items-center justify-between px-1">
              <div>
                <p className="font-heading text-lg font-bold text-[#000040]">
          ...
          {visibleProperties.length > 0 ? (
            <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {visibleProperties.map((property) => (
                <article
                  key={property.id}
                  className="group overflow-hidden rounded-[24px] border border-[#E1E6ED] bg-white shadow-[0_10px_35px_rgba(0,0,64,.06)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,0,64,.12)]"
                >
                  <div className="relative h-64 overflow-hidden bg-[#EDF2F7]">
                    ...
                    <div className="absolute left-4 top-4 flex gap-2">
                      ...
                      {property.featured && (
                        <span className="rounded-full bg-[#00B1FC] px-3 py-1.5 text-xs font-bold uppercase tracking-[0.08em] text-[#000040]">
                          Featured
                        </span>
                      )}
                    </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
                      <MapPin className="size-3.5 text-[#00B1FC]" />
                      {property.location}
                    </div>
                    <h3 className="mt-3 font-heading text-xl font-bold tracking-tight text-[#000040]">
                      {property.title}
                    </h3>
      ...
      <section
        id="owners"
        className="scroll-mt-20 bg-[#000040] px-5 py-20 text-white sm:px-8 lg:px-10 lg:py-24"
      >
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[.9fr_1.1fr]">
          <div className="relative mx-auto w-full max-w-xl">
            ...
            <div className="absolute -bottom-7 -right-2 max-w-[230px] rounded-2xl bg-[#E6F7FE] p-5 text-[#000040] shadow-2xl sm:right-6">
              <div className="flex items-center gap-1 text-[#00B1FC]">
                {[0, 1, 2, 3, 4].map((star) => (
          ...
          <div>
            <p className="section-kicker !text-[#70D7FF]">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {siteConfig.ownerSection.checklist.map((item) => (
                ...
                >
                  <CheckCircle2 className="size-5 shrink-0 text-[#70D7FF]" />
                  {item}
                </div>
              ))}
            </div>
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="mt-7 font-heading text-xl font-bold text-[#000040]">
                  {service.title}
                </h3>
      ...
      >
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[.9fr_1.1fr] lg:gap-20">
          <div className="relative mx-auto max-w-md lg:mx-0">
            <div className="absolute -inset-5 translate-x-3 translate-y-3 rounded-[34px] border border-[#00B1FC]/40" />
      ...
      >
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[32px] bg-white shadow-[0_20px_70px_rgba(0,0,64,.10)] lg:grid-cols-[.8fr_1.2fr]">
          <div className="bg-primary p-8 text-white sm:p-12 lg:p-14">
            ...
            <div className="mt-10 space-y-5">
              ...
              <a
                ...
                className="flex items-center gap-4 text-sm font-semibold"
              >
                <span className="grid size-10 place-items-center rounded-full bg-[#4133BA]">
                  <WhatsAppIcon className="size-4" />
                </span>
      ...
      <footer className="bg-[#000040] px-5 pb-8 pt-14 text-white sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 border-b border-white/10 pb-12 md:grid-cols-[1.5fr_1fr_1fr]">
            <div>
              <a href="#top" className="flex items-center gap-3">
                <span className="grid size-11 place-items-center rounded-full bg-[#00B1FC] font-heading text-sm font-bold text-[#000040]">
                  {siteConfig.logo.image ? (
                    <Image
                      src={siteConfig.logo.image}
                      alt={`${siteConfig.agent.name} logo`}
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.15em] text-[#00B1FC]">
