    ...
    <main className="grid min-h-screen place-items-center bg-[#f3f1e9] px-5 py-12">
      <div className="w-full max-w-md rounded-[2rem] bg-white p-7 shadow-[0_24px_70px_rgba(25,56,45,.12)] ring-1 ring-black/5 sm:p-9">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#b97738]">Secure account</p>
          <h1 className="mt-2 font-heading text-3xl font-bold text-[#19382d]">Choose a new password</h1>
        ...
        {checking ? (
          <div className="mt-7 flex items-center justify-center gap-2 text-sm font-semibold text-[#49685b]">
            <LoaderCircle className="size-4 animate-spin" /> Checking your recovery link…
          </div>
        ) : (
          <form onSubmit={updatePassword} className="mt-7 grid gap-4">
            <label htmlFor="new-password" className="grid gap-2 text-sm font-semibold text-[#34483f]">
              New password
              <Input
                type="password"
                id="new-password"
            ...
            <label htmlFor="confirm-password" className="grid gap-2 text-sm font-semibold text-[#34483f]">
